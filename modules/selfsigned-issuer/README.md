...
A [timoni.sh](http://timoni.sh) module for deploying selfsigned-issuer to Kubernetes clusters.
...
```shell
timoni -n default apply selfsigned-issuer oci://<container-registry-url>
```
...
```shell
timoni -n default delete selfsigned-issuer
```
