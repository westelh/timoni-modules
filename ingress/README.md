...
A [timoni.sh](http://timoni.sh) module for deploying ingress to Kubernetes clusters.
...
```shell
timoni -n default apply ingress oci://ghcr.io/westelh/timoni/modules/ingress
```
...
```shell
timoni -n default delete ingress
```
