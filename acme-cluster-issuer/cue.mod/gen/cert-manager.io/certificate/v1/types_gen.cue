...
#CertificateSpec: {
	...
	keystores?: {
		...
		pkcs12?: {
			...
			// (e.g., because of company policy). Please note that the
			// security of the algorithm is not that important
	...
	privateKey?: {
		...
		// Default is `Always`.
		// The default was changed from `Never` to `Always` in
		// cert-manager >=v1.18.0.
		// The new default can be disabled by setting the
		// `--feature-gates=DefaultPrivateKeyRotationPolicyAlways=false`
		// option on
	...
	// Allowed values for RSA keys: SHA256WithRSA, SHA384WithRSA,
	// SHA512WithRSA.
	// Allowed values for ECDSA keys: ECDSAWithSHA256,
	// ECDSAWithSHA384, ECDSAWithSHA512.
