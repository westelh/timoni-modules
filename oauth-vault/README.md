...
A [timoni.sh](http://timoni.sh) module for deploying oauth-vault to Kubernetes clusters.
...
```shell
timoni -n default apply oauth-vault oci://ghcr.io/westelh/timoni/modules/oauth-vault
```
...
```shell
timoni -n default delete oauth-vault
```
