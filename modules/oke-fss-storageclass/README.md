...
A [timoni.sh](http://timoni.sh) module for deploying oke-fss-storageclass to Kubernetes clusters.
...
```shell
timoni -n default apply oke-fss-storageclass oci://<container-registry-url>
```
...
```shell
timoni -n default delete oke-fss-storageclass
```
