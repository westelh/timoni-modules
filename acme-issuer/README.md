...
A [timoni.sh](http://timoni.sh) module for deploying acme-issuer to Kubernetes clusters.
...
```shell
timoni -n default apply acme-issuer oci://ghcr.io/westelh/timoni/modules/acme-issuer
```
...
```shell
timoni -n default delete acme-issuer
```
