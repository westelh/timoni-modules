...
//timoni:generate timoni mod vendor crd -f https://github.com/cert-manager/cert-manager/releases/download/v1.19.2/cert-manager.yaml
...
#ChallengeSpec: {
	...
	// example.com.
	// If the requested DNSName is a 'wildcard', this field MUST be
	// set to the
	// non-wildcard domain, e.g., for `*.example.com`, it must be
	// `example.com`.
	dnsName!: string
	...
	// For HTTP01 challenges, this is the value that must be responded
	// with to
	// complete the HTTP01 challenge in the format:
	// `<private key JWK thumbprint>.<key from acme server for
	// challenge>`.
	// For DNS01 challenges, this is the base64 encoded SHA256 sum of
	// the
	// `<private key JWK thumbprint>.<key from acme server for
	// challenge>`
	...
	solver!: {
		...
		dns01?: {
			...
			azureDNS?: {
				...
				managedIdentity?: {
					// client ID of the managed identity, cannot be used at the same
					// time as resourceID
					clientID?: string

					// resource ID of the managed identity, cannot be used at the same
					// time as clientID
					// Cannot be used for Azure Managed Service Identity
					resourceID?: string

					// tenant ID of the managed identity, cannot be used at the same
					// time as resourceID
					tenantID?: string
				}
			...
			rfc2136?: {
				...
				// Protocol to use for dynamic DNS update queries. Valid values
			...
			gatewayHTTPRoute?: {
				...
				podTemplate?: {
					...
					spec?: {
						...
						// Note that when only specifying resource limits, ensure they are
						// greater than or equal
						// to the corresponding global resource requests configured via
						// controller flags
						// (--acme-http01-solver-resource-request-cpu,
						// --acme-http01-solver-resource-request-memory).
						// Kubernetes will reject pod creation if limits are lower than
						// requests, causing challenge failures.
						resources?: {
							...
							// otherwise to the global values configured via controller flags.
	...
	// This can be used to lookup details about the status of this
	// challenge.
	url!: string
