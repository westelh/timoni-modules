...
A [timoni.sh](http://timoni.sh) module for deploying oci-native-ingressclass to Kubernetes clusters.
...
```shell
timoni -n default apply oci-native-ingressclass oci://<container-registry-url>
```
...
```shell
timoni -n default delete oci-native-ingressclass
```
